...
// Verifique se o id do contato existe, por exemplo update.php? Id = 1 irá obter o contato com o id 1
if(isset($_GET['id'])){
    if (!empty($_POST)) {
    ...
    // Obtenha o contato da tabela de contatos
    ...
    exit('ID no specified!');
}

/*O código acima irá verificar o ID do contato, o ID será um parâmetro na URL, 
por exemplo, http: //localhost/phpcrud/update.php? Id = 1 obterá o contato com o ID 1, 
e então podemos lidar com a solicitação com o método GET e executar uma consulta MySQL que obterá o contato por ID.*/
